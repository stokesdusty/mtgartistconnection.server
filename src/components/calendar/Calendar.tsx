    ...
    return <Box sx={calendarStyles.container}>
        <Typography variant="h2" fontFamily={"Work Sans"} fontWeight={600}>Signing Calendar</Typography>
            <Box sx={calendarStyles.eventContainer}>
                ...
                <Link sx={calendarStyles.artistLink} href="./artist/Alex%20Dos%20Diaz">Alex Dos Dias</Link>
                <Link sx={calendarStyles.artistLink} href="./artist/Andrea%20Radeck">Andrea Radeck</Link>
                <Link sx={calendarStyles.artistLink} href="./artist/Ben%20Hill">Ben Hill</Link>
                ...
                <Link sx={calendarStyles.artistLink} href="./artist/Eric%20Deschamps">Eric Deschamps</Link>
                Erica Williams
                <Link sx={calendarStyles.artistLink} href="./artist/Jeff%20A%20Menges">Jeff A Menges</Link>
                <Link sx={calendarStyles.artistLink} href="./artist/John%20Stanko">John Stanko</Link>
                Khuruum
                <Link sx={calendarStyles.artistLink} href="./artist/Mark%20Behm">Mark Behm</Link>
                <Link sx={calendarStyles.artistLink} href="./artist/Mark%20Poole">Mark Poole</Link>
                <Link sx={calendarStyles.artistLink} href="./artist/Michael%20C%20Hayes">Michael Hayes</Link>
                ...
                <Link sx={calendarStyles.artistLink} href="./artist/Scott%20Murphy">Scott Murphy</Link>
            </Box>
            <Box sx={calendarStyles.eventContainer}>
                <Typography variant="h4">August 11 - 13:   MXP Laughing Dragon - Tacoma, WA</Typography>
                <Link sx={calendarStyles.artistLink} href="./artist/Alayna%20Danner">Alayna Danner</Link>
                <Link sx={calendarStyles.artistLink} href="./artist/Brian%20Snoddy">Brian Snoddy</Link>
                <Link sx={calendarStyles.artistLink} href="./artist/Bruce%20Brenneise">Bruce Brenneise</Link>
                <Link sx={calendarStyles.artistLink} href="./artist/Cynthia%20Sheppard">Cynthia Sheppard</Link>
                ...
                <Link sx={calendarStyles.artistLink} href="./artist/Lucas%20Graciano">Lucas Graciano</Link>
                <Link sx={calendarStyles.artistLink} href="./artist/Margaret%20Organ-Kean">Margaret Organ-Kean</Link>
                <Link sx={calendarStyles.artistLink} href="./artist/Mark%20Poole">Mark Poole</Link>
                <Link sx={calendarStyles.artistLink} href="./artist/Mark%20Tedin">Mark Tedin</Link>
                <Link sx={calendarStyles.artistLink} href="./artist/Pete%20Venters">Pete Venters</Link>
                <Link sx={calendarStyles.artistLink} href="./artist/Phil%20Foglio">Phil Foglio</Link>
                <Link sx={calendarStyles.artistLink} href="./artist/RK%20Post">rk Post</Link>
